# -*- coding: utf-8 -*-
from model_Fusion import Fusion_model
from utils import input_setup_image
import numpy as np
...
flags.DEFINE_integer("image_size", 80, "The size of label to produce [21]")
